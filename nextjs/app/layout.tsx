...
export const metadata: Metadata = {
  ...
  description: 'Skill Hub 收录 5884+ AI Agent Skills & MCP Tools，按22个功能分类浏览。支持 Claude Code、Codex、Cursor、OpenCode、Hermes Agent 等平台。',
  ...
  openGraph: {
    ...
    description: 'Skill Hub 收录 5884+ AI Agent Skills & MCP Tools，按22个功能分类浏览。',
    images: ['/og-image.png'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Skill Hub - AI Agent Skills 导航站',
    description: 'Skill Hub 收录 5884+ AI Agent Skills & MCP Tools',
    images: ['/og-image.png'],
  },
}
